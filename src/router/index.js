...
import ActivateMailPage from '../views/ActivateMailPage'
import VerifyEmailPage from '../views/VerifyEmailPage'
import HomePage from '../views/HomePage'
import SpacePage from '../views/SpacePage'
import UploadPage from '../views/UploadPage'
import UploadDetailPage from '../views/UploadDetailPage'
import VideoDetailPage from '../views/VideoDetailPage'
import TagVideoPage from '../views/TagVideoPage'
import SearchInfoPage from '../views/SearchInfoPage'
import PayInfoPage from '../views/PayInfoPage'
import PayPage from '../views/PayPage'
import OrdersPage from '../views/OrdersPage'
import ManagerManuscriptsPage from '../views/ManagerManuscriptsPage'
import ManagerTagsPage from '../views/ManagerTagsPage'
import ManagerUsersPage from '../views/ManagerUsersPage'
...
const routes = [
    ...
    {
        path: '/video/tag/:tagName',
        name: 'TagVideoPage',
        component: TagVideoPage,
        meta: {
            title: '标签视频 || HiliHili',
        },
    },
    ...
    {
        path: '/manager/manuscripts',
        name: 'ManagerManuscriptsPage',
        component: ManagerManuscriptsPage,
        meta: {
            title: '视频审核 || HiliHili Manager',
        },
    },
    {
        path: '/manager/tags',
        name: 'ManagerTagsPage',
        component: ManagerTagsPage,
        meta: {
            title: '标签管理 || HiliHili Manager',
        },
    },
    {
        path: '/manager/users',
        name: 'ManagerUsersPage',
        component: ManagerUsersPage,
        meta: {
            title: '用户管理 || HiliHili Manager',
        },
    },

    
    // ===========================================往上的才是我的界面，剩下的只是留着以防万一要用===========================================

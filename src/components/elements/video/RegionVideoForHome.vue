<template>
    <div class="row row--15">
        <div class="row">
            <div class="col-lg-12">
                <SectionTitle text-align="center" subtitle="分区" :title="RegionTitle" description="hilihili有丰富的分区和作品"
                    data-aos="fade-up" />
            </div>
        </div>
                            ...
                            <div class="rn-card box-card-style-default"
                                ...
                                <div class="inner">
                                    ...
                                    <div class="content">
                                        ...
                                        <ul class="rn-meta-list" v-if="blog.form == 'VIP可见'">
                                            <li class="separator">/</li>
                                            <li style="color: gold;">
                                                {{ blog.form }}
                                            </li>
...
export default {
    ...
    methods: {
        getManuscriptsByTime() {
            ...
            this.$axios.get(`/video/home/byRegion/${this.RegionTitle}/datetime/${this.currentPageManuscripts}/${this.pageSizeManuscripts}`).then(res => {
                console.log(res);
                if (res.data.state == 0) {
        ...
        getManuscriptsByViews() {
            ...
            this.$axios.get(`/video/home/byRegion/${this.RegionTitle}/views/${this.currentPageManuscripts}/${this.pageSizeManuscripts}`).then(res => {
                console.log(res);
                if (res.data.state == 0) {

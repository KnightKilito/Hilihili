<template>
    <div :class="{ 'header-transparent-with-topbar': data.headerTransparency }">
        ...
        <div v-if="data.showTopHeader && data.topbarStyle === 2" class="header-top-bar">
            <div class="container">
                    ...
                    <div class="col-lg-8 col-md-12 col-12">
                        <div class="header-right">
                            <div class="address-content">
                                <p>
                                    <Icon name="map-pin" /><span>Alabama, USA</span>
                                </p>
                                <p>
                                    <Icon name="phone" /><span><a href="#">+06 58 49 99 56</a></span>
                                </p>
                            </div>
                            <div class="social-icon-wrapper">
                                <ul class="social-icon social-default icon-naked">
                                    <li><a href="https://github.com/KnightKilito" target="_blank">
                                            <Icon name="github" />
                                        </a></li>
                                    <li><a href="https://space.bilibili.com/23042208" target="_blank">
                                            <Icon name="tv" />
                                        </a></li>
                                    <li><a href="https://moechun.fun/" target="_blank">
                                            <Icon name="bold" />
                                        </a></li>
                                    <li><a href="https://moechun.fun/img/vx-reward.png" target="_blank">
                                            <Icon name="coffee" />
                                        </a></li>
                                </ul>
                            </div>
                        ...
                        <div class="col-lg-9 col-md-6 col-8 position-static">
                            <div class="header-right">
                                ...
                                <div class="header-btn">
                                    <a :class="data.buyButtonClass" href="/upload">
                                        投稿
                                    </a>
                                </div>
                                <!-- End Header Btn  -->
